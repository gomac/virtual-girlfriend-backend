...
const AZURE_SPEECH_KEY = process.env.PUBLIC_AZURE_SPEECH_KEY;
const AZURE_SPEECH_REGION = process.env.PUBLIC_AZURE_SPEECH_REGION;
const AZURE_VOICE_NAME = process.env.PUBLIC_AZURE_VOICE_NAME;
